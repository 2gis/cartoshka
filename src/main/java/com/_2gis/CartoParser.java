...
import com._2gis.function.Functions;
import com._2gis.scanner.Scanner;
import com._2gis.scanner.Source;
import com._2gis.scanner.Token;
import com._2gis.scanner.TokenType;
import com._2gis.tree.*;
import com._2gis.tree.entities.*;
import com._2gis.tree.entities.literals.Boolean;
import com._2gis.tree.entities.literals.*;
...
public final class CartoParser extends Scanner {
    ...
    private Expression parsePrimaryExpression() {
        switch (peek().getType()) {
            ...
            case TRUE_LITERAL:
                return new com._2gis.tree.entities.literals.Boolean(next().getLocation(), true);
